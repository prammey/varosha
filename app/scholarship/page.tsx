  ...
  return (
    <div className="bg-plum text-on-plum">
      ...
      <Container narrow className="flex flex-col items-center gap-9 pb-[clamp(60px,8vw,120px)] text-center">
        ...
        <Reveal delay={1}>
          <span className="inline-block -rotate-[1.5deg] rounded-xl bg-gold px-[1.1em] py-[0.6em] font-sans font-bold text-plum-2">{scholarship.deadline}</span>
        </Reveal>

        <Reveal delay={2} className="flex flex-wrap items-center justify-center gap-3">
          <Button href={scholarship.applyUrl} variant="gold" external>Start application</Button>
