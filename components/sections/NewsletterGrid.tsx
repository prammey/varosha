    ...
    <div className="grid grid-cols-[repeat(auto-fill,minmax(118px,1fr))] gap-3">
      {newsletters.map((n) => (
        <a
          ...
          target="_blank"
          rel="noopener"
          className="flex flex-col gap-1 rounded-card-sm bg-plum-3 px-3 py-5 text-center font-sans font-bold text-on-plum no-underline transition-[transform,background-color,color] duration-200 hover:-translate-y-1 hover:-rotate-[1.5deg] hover:bg-gold hover:text-plum-2"
        >
