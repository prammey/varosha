...
const items: Item[] = [
  {
    key: "fb", label: "Facebook", href: site.social.facebook, hover: "hover:bg-[#1877F2] hover:text-white",
  ...
  {
    key: "x", label: "X / Twitter", href: site.social.x ?? "/contact", hover: "hover:bg-black hover:text-white",
    path: "M17.5 3h3l-6.8 7.8L21.7 21h-6.2l-4.9-6.4L5 21H2l7.3-8.3L1.6 3h6.4l4.4 5.8L17.5 3zm-1 16h1.7L6.6 4.9H4.8L16.5 19z",
  },
  {
    key: "yt", label: "YouTube", href: site.social.youtube ?? "/contact", hover: "hover:bg-[#FF0000] hover:text-white",
  ...
  {
    key: "ig", label: "Instagram", href: site.social.instagram ?? "/contact", hover: "hover:bg-[linear-gradient(45deg,#f9ce34,#ee2a7b,#6228d7)] hover:text-white",
